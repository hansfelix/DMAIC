...
<v-dialog v-model="dialog" max-width="320px">
      ...
      <!-- </v-tabs-content> -->
        ...
        <v-card flat>
          <v-card-text>a2222222d</v-card-text>
        </v-card> -->
      <!-- </v-tabs-content>
    </v-tabs-items> -->
  <!-- </v-tabs> -->
