      ...
      <v-layout row align-center wrap>
        ...
        <v-flex xs12 md12 align-center>
          ...
          <p>Se muestra la configuración que tiene la medición del proceso
            <!-- <strong>"{{procesoActual.dataprocesoActual.nombreProceso}}"</strong>   RECUPERARRRRRRR-->
            en el proyecto
            <strong>{{proyectoActual.cr}} - {{proyectoActual.nombrePyt}} </strong>.
          </p>
        </v-flex>
                            ...
                            <v-card>
                              ...
                              <v-card-text>
                                <v-container grid-list-md>
                                  <v-layout wrap>
                                    <v-flex xs12>
                                      <v-text-field name="input-3" label="Ingrese la nueva duración del intervalo (en segundos)" v-model="duracion"></v-text-field>
                                    </v-flex>
                                    <v-flex xs12>
                            ...
                            <v-card>
                              ...
                              <v-card-text>
                                <v-container grid-list-md>
                                  <v-layout wrap>
                                    <v-flex xs12>
                                      <v-text-field name="txt_nombreObrero" label="Nombre del Obrero" value="" v-model="txt_nombreObrero"></v-text-field>
                                    </v-flex>
                                    <v-flex xs12>
                                      <small>*Campos obligatorios</small>
                                    </v-flex>
                            ...
                            <v-card>
                              ...
                              <v-card-text>
                                <v-container grid-list-md>
                                  <v-layout wrap>
                                    <v-flex xs9>
                                      <v-text-field name="txt_nombreObrero" label="Prefijo" value="" v-model="dialogs.dialog_obreros.prefijo"></v-text-field>
                                    </v-flex>
                                    <v-flex xs3>
                                      <v-select :items="dialogs.dialog_obreros.numbers" v-model="dialogs.dialog_obreros.number" label="Cantidad de obreros" single-line
                                        bottom></v-select>
                                    </v-flex>
                                    <v-flex xs12>
                                      <small>*Campos obligatorios</small>
                            ...
                            <v-card>
                              ...
                              <v-card-text>
                                <v-container grid-list-md>
                                  <v-layout wrap>
                                    <v-flex xs12>
                                      <v-text-field name="input-3" label="Nombre de la actividad" value="" v-model="dialogs.dialog_actividades.txt_nombreActividad"></v-text-field>

                                      <v-text-field name="input-3" label="Abreviatura de la actividad" value="" v-model="dialogs.dialog_actividades.txt_abreviaturaActividad"></v-text-field>

                                      <v-select :items="dialogs.dialog_actividades.itemsActividad" v-model="dialogs.dialog_actividades.txt_tipoActividad" label="Tipo de la actividad"
                            ...
                            <v-card>
                              ...
                              <v-card-text>
                                <v-container grid-list-md>
                                  <v-layout wrap>
                                    <v-flex xs12>
                                      <v-select :items="dialogs.dialog_importarActividades.librerias" v-model="dialogs.dialog_importarActividades.libreria" label="Escoja una librería"
                                        single-line bottom></v-select>
                                    </v-flex>
                                    <v-flex xs12>
                                      <small>*Campos obligatorios</small>
        ...
        <v-flex xs12 md9 align-center>
          ...
          <v-btn ripple color="primary" :to="'/TomaDatos/' + this.$route.params.proyecto_uid  +'/' + this.$route.params.idproceso + this.$route.params.proyecto_uid  +'/' + this.$route.params.medicion_uid ">
          ...
          <v-btn ripple color="primary" :to="'/Reporte/' + this.$route.params.proyecto_uid  +'/' + this.$route.params.idproceso ">
            ver reporte
            <v-icon right dark>update</v-icon>
          </v-btn>
              ...
              <v-card>
                ...
                <v-card-text>
                  <v-container grid-list-md>
                    <v-layout wrap>
                      <v-flex xs12 md12>
                        <v-select v-bind:items="itemsTipoReporte" v-model="txt_tipoReporte" label="Tipo de Reporte" single-line bottom></v-select>
                      </v-flex>
                      <!-- 
  ...
  export default {
    ...
    methods: {
      ...
      openDialogGenerarReporte(idTomaDatos) {
        ...
        this.$store.dispatch("cargar_medicion", payload);
    ...
    created() {
      const payload = {
        proyecto_uid: this.$route.params.proyecto_uid,
        proceso_uid: this.$route.params.idproceso
      };
      this.$store.dispatch("cargar_medicionActual", payload).then(() => {
